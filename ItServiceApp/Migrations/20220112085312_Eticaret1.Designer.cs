...
namespace ItServiceApp.Migrations
{
    ...
    [Migration("20220112085312_Eticaret1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItServiceApp.Models.Identity.AplicationRole", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ItServiceApp.Models.Identity.AplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ItServiceApp.Models.Identity.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
